  ...
  vue_slider_createClass(VueSlider, [{
    ...
    value: function setIndex(index) {
      ...
      var value = Array.isArray(index) ? index.map(function (n) {
        return _this5.control.getValueByIndex(n);
    ...
    value: function setValueByPos(pos) {
      ...
      setTimeout(function () {
        if (_this6.included && _this6.isNotSync) {
          _this6.control.setValue(_this6.value);
        } else {
    ...
    value: function render() {
      ...
      return h("div", {
        ...
        return h("div", {
          ...
          "style": [baseStyle, _this7.processStyle]
        });
      }), this.marks ? h("div", {
        ...
        return h("vue-slider-dot", {
          ...
          "attrs": {
            ...
            "tooltip-formatter": _this7.tooltipFormatter,
    ...
    get: function get() {
      ...
      return this.control.processArray.map(function (_ref4) {
        ...
        return vue_slider_objectSpread((_objectSpread2 = {}, vue_slider_defineProperty(_objectSpread2, _this8.isHorizontal ? 'height' : 'width', '100%'), vue_slider_defineProperty(_objectSpread2, _this8.isHorizontal ? 'top' : 'left', 0), vue_slider_defineProperty(_objectSpread2, _this8.mainDirection, "".concat(start, "%")), vue_slider_defineProperty(_objectSpread2, sizeStyleKey, "".concat(end - start, "%")), vue_slider_defineProperty(_objectSpread2, "transitionProperty", "".concat(sizeStyleKey, ",").concat(_this8.mainDirection)), vue_slider_defineProperty(_objectSpread2, "transitionDuration", "".concat(_this8.animateTime, "s")), _objectSpread2), style);
      });
    }
  }, {
    key: "dotBaseStyle",
